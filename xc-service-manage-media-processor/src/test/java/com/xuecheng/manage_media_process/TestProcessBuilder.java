...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testFFMpeg() throws IOException {
        ...
        command.add("E:/software/ffmpeg/bin/ffmpeg.exe");
        command.add("-i");
        command.add("E:/develop/ffmpeg_test/1.avi");
        ...
        command.add("-r");
        command.add("18");
        command.add("E:/develop/ffmpeg_test/1.mp4");
...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testProcessMp4(){
        ...
        //ffmpeg的路径
        String ffmpeg_path = "E:/software/ffmpeg/bin/ffmpeg.exe";
        //video_path视频地址
        String video_path = "E:/develop/ffmpeg_test/1.avi";
        //mp4_name mp4文件名称
        String mp4_name  ="1.mp4";
        //mp4folder_path mp4文件目录路径
        String mp4folder_path="E:/develop/ffmpeg_test/";
